...
public class ViewStudentScheduleMenuActionTest extends TestCase {
	...
	ViewStudentScheduleMenuAction viewStudentScheduleMenuAction;
    ...
    public void setUp() {
    	...
    	viewStudentScheduleMenuAction = new ViewStudentScheduleMenuAction();
        viewStudentScheduleMenuAction.setScheduleManager(mockScheduleManager);
        viewStudentScheduleMenuAction.setUser(newUser);
    }
    ...
    public void testToString() {
    	assert(viewStudentScheduleMenuAction.toString().contains("schedule");
    }    
    
    /*
     * Test output when student is not registered in courses
     */
    public void testZeroCourses() {
    	when(mockScheduleManager.getStudentSchedule(anyString()))
    		.thenReturn(new ArrayList<Course>());
    	
    	viewStudentScheduleMenuAction.execute();
    	...
    	verify(mockScheduleManager).getStudentSchedule(username);
    }
    
    /*
     * Registered in only one course
     */
